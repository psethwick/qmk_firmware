/* Copyright 2015-2021 Jack Humbert and Seth Rider
 *
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Esc/N| Tab  | Alt  | GUI  |Lower |    Space    |Raise | Left | Down |  Up  |Ent/N |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    LT(_NAV, KC_ESC), KC_LEFT, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_DOWN, KC_UP, KC_RIGHT,   LT(_NAV, KC_ENT)
),
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |  F7  |  F8  |  F9  |  F10 |  F11 | F12  |Pg Dn |Pg Up |Right |Pg Dn |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      | Next | Vol- | Vol+ | Play |
 * `-----------------------------------------------------------------------------------'
 */
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12, KC_DOWN, KC_UP, KC_RIGHT, KC_PGDN, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),

/* Nav
 * ,-----------------------------------------------------------------------------------.
 * |   `  |   1  |   2  |   3  |   4  |   5  | Home |Pg Dn |Pg Up | End  |   0  | Bksp |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_NAV] = LAYOUT_planck_grid(
    KC_GRV,  G(KC_1), G(KC_2), G(KC_3), G(KC_4), G(KC_5), G(KC_6), G(KC_7), G(KC_8), G(KC_9), G(KC_0),    KC_BSPC,
